...
publishing {
    publications {
        create<MavenPublication>("mavenCentral") {
            artifactId = "kdatamapper-$artifactId"
            from(components["java"])
            artifact(javadocJar)

            pom {
                name.set("kdatamapper")
                afterEvaluate {
                    this@pom.description.set(project.description)
                }
                url.set("https://github.com/darkxanter/kdatamapper")
                ...
                scm {
                    url.set("https://github.com/darkxanter/kdatamapper")
                    connection.set("scm:git:git://github.com/darkxanter/kdatamapper.git")
                    developerConnection.set("scm:git:git@github.com:darkxanter/kdatamapper.git")
                }
                developers {
                    developer {
